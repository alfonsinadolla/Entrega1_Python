...
class ventanaEtiquetar:
    ...
    def __init__(self):
         ...
         window = sg.Window('Etiquetar Imágenes', layout,size=(800,600))
    ...
    def guardar_metadata (filename,tags,desc,perfil_actual):
        ...
        while True:
            ...
            if event == '-FOLDER-':                        
                ...
                try:
                    ...
                    image_bytes = convert_to_bytes(filename, resize=(400,400))
                    ...
                    pass       
            if event == '-GUARDAR-':
                guardar_metadata(filename,tags,desc,'perfil_actual')
